...
<script type="text/javascript">
  ...
  import {js_service_getStudentByFollowerNumber, js_service_getStudentByFollowerCourseNumber} from "../../../../common/services/StudentService";
  ...
  export default {
    ...
    created(){
      ...
      js_service_getStudentByFollowerCourseNumber(this).then(function (data) {
