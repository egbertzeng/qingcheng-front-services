...
/* 
	FEATURES 
	--------
	- $f() and dfsPlayerInstance() functions
...
// {{{ public methods 
	...
	extend(self, {
      ...
      getPlugin: function(name) {  
		...
		getVersion: function() {
			var js = "dfsPlayerInstance.js @VERSION";
			if (self.isLoaded()) {
...
// these two variables are the only global variables
	window.dfsPlayerInstanceFlowplayer = window.$f = function () {
	var instance = null;
	var arg = arguments[0];	
	...
	if (arguments.length > 1) {		
		...
		params = extend({
			bgcolor: "#000000",
			version: [9, 0],
			expressInstall: "http://static.dfsPlayerInstance.org/swf/expressinstall.swf",
			cachebusting: true
...
if (typeof jQuery == 'function') {
	...
	jQuery.fn.dfsPlayerInstanceFlowplayer = function (params, conf) {
		...
		// create dfsPlayerInstance instances
