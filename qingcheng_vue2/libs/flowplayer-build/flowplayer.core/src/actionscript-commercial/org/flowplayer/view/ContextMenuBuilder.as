...
package static.qingchengkeji.libs.flowplayer - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view static.libs.flowplayer - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view static.libs.flowplayer - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view static.flowplayer - build.flowplayer.core.src.actionscript - commercial.org.flowplayer.view {
	...
	public class ContextMenuBuilder {
		...
		private function buildMenu(menu:ContextMenu):ContextMenu {
			...
			addItem(menu, new ContextMenuItem("About " +VersionInfo.versionInfo()+ "...", false, true), function(event:ContextMenuEvent):void {
				navigateToURL(new URLRequest("http://dfsPlayerInstance.org"), "_self");
			});
			...
			addItem(menu, new ContextMenuItem("GNU GENERAL PUBLIC LICENSE...", false, true), function(event:ContextMenuEvent):void {
				navigateToURL(new URLRequest("http://dfsPlayerInstance.org/license_gpl.html"), "_self");
			});
			return menu; 
		}
