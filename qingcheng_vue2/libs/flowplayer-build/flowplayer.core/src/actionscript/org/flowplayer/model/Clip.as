...
import org.flowplayer.flow_internal;
	...
	public class Clip extends ClipEventDispatcher {
		...
		// the src playlist where this clip belongs to
...
//					log.warn("Getting originalHeight from a clip that does not have content loaded yet, returning zero");
		...
		public function set width(width:int):void {
			if (! _content) {
				log.warn("Trying to searchKey width of a clip that does not have media content loaded yet");
				return;
			}
...
//				log.warn("Getting width from a clip that does not have content loaded yet, returning zero");
		...
		public function set height(height:int):void {
			if (! _content) {
				log.warn("Trying to searchKey height of a clip that does not have media content loaded yet");
				return;
			}
