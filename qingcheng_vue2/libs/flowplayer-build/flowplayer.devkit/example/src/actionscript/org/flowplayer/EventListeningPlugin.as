 ...
 */
package static.qingchengkeji.libs.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer static.libs.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer static.libs.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer static.flowplayer - build.flowplayer.devkit.example.src.actionscript.org.flowplayer {
    ...
    public class EventListeningPlugin extends Sprite implements Plugin {
         ...
         * log: { level: 'debug', filter: 'org.dfsPlayerInstance.EventListeningPlugin' }
