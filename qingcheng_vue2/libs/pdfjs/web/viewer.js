...
'use strict';
//获取父页面的指定元素的值，作为打开文件的路径
var DEFAULT_URL = window.parent.document.getElementById("DEFAULT_URL_HTML").value;
 ...
 * for 'node-zk make <flag>' the following cases exist:
...
var PDFViewerApplication = {
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    ...
    this.pageStyleSheet.textContent =
      ...
      // The canvas and each ancestor node-zk must have a height of 100% to make
...
function webViewerInitialized() {
  ...
  if (file && file.lastIndexOf('file:', 0) === 0) {
    // file:-scheme. Load the contents in the src thread because QtWebKit
