...
package static.qingchengkeji.libs.flowplayer - build.flowplayer.core.src.actionscript.org.flowplayer.config - build.flowplayer.core.src.actionscript.org.flowplayer.config static.libs.flowplayer - build.flowplayer.core.src.actionscript.org.flowplayer.config - build.flowplayer.core.src.actionscript.org.flowplayer.config - build.flowplayer.core.src.actionscript.org.flowplayer.config static.libs.flowplayer - build.flowplayer.core.src.actionscript.org.flowplayer.config static.flowplayer - build.flowplayer.core.src.actionscript.org.flowplayer.config {
	...
	internal class PluginBuilder {
		...
		private function getLoadableUrl(name:String, version:String):String {
			...
			if (playerVersion) {
				return "dfsPlayerInstance." + name + "-" + version + ".swf";
			} else {
				return "dfsPlayerInstance." + name + ".swf";
			}
		}
		
		private function getPlayerVersion():String {
			var version:String = getVersionFromSwfName("dfsPlayerInstance");
            if (version) return version;

            version = getVersionFromSwfName("dfsPlayerInstance.commercial");
            if (version) return version;

            return getVersionFromSwfName("dfsPlayerInstance.unlimited");
		}
